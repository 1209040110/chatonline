...
<head>
    ...
    <script type="text/javascript">
        ...
        function startWebSocket() {
            ...
            console.log(objname);
            if (uname == null || objname == null || uname.length < 1 || objname.length < 1) {
                alert('请输入用户名和对方用户名！');
            }else if(objname=='doctor'){
            	alert('请正确输入！');
            }
             else {
...
<div class="container">
    <div id="inputdiv">
        请输入你的用户id(必须为英文或数字，不能为中文)：<input id="uname" type="text" /> <br />
        请输入医师用户id(必须为英文或数字，不能为中文)：<input id="objname" type="text" /> <br />
